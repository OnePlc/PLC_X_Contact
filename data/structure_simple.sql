...
ADD `phone` VARCHAR(255) NOT NULL DEFAULT '' AFTER `email_addr`,
ADD `featured_image` VARCHAR(255) NOT NULL DEFAULT '' AFTER `phone`,
ADD `salution_idfs` INT(11) NOT NULL DEFAULT '0' AFTER `featured_image`,
ADD `title_idfs` INT(11) NOT NULL DEFAULT '0' AFTER `salution_idfs`;
