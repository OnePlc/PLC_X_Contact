...
use OnePlace\Contact\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/contact/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('contact-api');
    }
}
